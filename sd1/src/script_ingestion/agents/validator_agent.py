...
class ValidatorAgent:
    def __init__(self):
        ...
        self.instructions = AGENT_INSTRUCTIONS["validator"]
    ...
    async def validate_data(self, parsed_data: Dict[str, Any], metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("Received validation response from Gemini")
            
            try:
                # Safe content extraction (same as parser agent)
                ...
                try:
                    ...
                    logger.info("Successfully extracted validation text using safe extraction method")
