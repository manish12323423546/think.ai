...
class MetadataAgent:
    def __init__(self):
        ...
        self.instructions = AGENT_INSTRUCTIONS["metadata"]
    ...
    async def extract_metadata(self, scene_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("Received metadata response from Gemini")
            ...
            try:
                ...
                try:
                    ...
                    logger.info("Successfully extracted metadata text using safe extraction method")
