...
class DialogueProfilerAgent:
    def __init__(self):
        ...
        self.instructions = AGENT_INSTRUCTIONS["dialogue_profiler"]
    ...
    async def analyze_characters(self, scene_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            full_prompt = f"{self.instructions}\n\n{self._generate_analysis_prompt(scene_data)}"
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Character breakdown validation error: {e}")
                ...
                logger.debug(f"Raw response: {response_text[:500] if 'response_text' in locals() else 'No response text'}")
                return self._create_fallback_analysis(scene_data)
